...
export default class PrmProductAutoListingServiceGetListingTemplatePage extends MBSCommand {
  ...
  async run(): Promise<void> {
    ...
    const data = await this.client.post('/product-auto-listing-service/listing/listingTemplate/getListingTemplatePage', { "erpSpu": flags.erpSpu, "platformType": flags.platformType })
    this.output(data)
  }
}

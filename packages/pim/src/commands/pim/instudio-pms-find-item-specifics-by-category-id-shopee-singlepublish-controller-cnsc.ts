...
export default class PimInstudioPmsFindItemSpecificsByCategoryIdShopeeSinglepublishControllerCnsc extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindItemSpecificsByCategoryIdShopeeSinglepublishControllerCnsc)

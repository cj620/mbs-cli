...
export default class PimInstudioPmsGetPicInfosByPicStyleEbaySinglepublishInfoController extends MBSCommand {
  static description = '获取套图对应信息：获取套图对应信息'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetPicInfosByPicStyleEbaySinglepublishInfoController)

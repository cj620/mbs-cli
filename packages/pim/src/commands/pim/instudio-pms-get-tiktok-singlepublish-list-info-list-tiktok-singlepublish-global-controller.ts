...
export default class PimInstudioPmsGetTiktokSinglepublishListInfoListTiktokSinglepublishGlobalController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetTiktokSinglepublishListInfoListTiktokSinglepublishGlobalController)

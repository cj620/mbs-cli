...
export default class PimInstudioPmsFindProductTort extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindProductTort)

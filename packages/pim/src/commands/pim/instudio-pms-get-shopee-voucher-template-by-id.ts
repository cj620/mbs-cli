...
export default class PimInstudioPmsGetShopeeVoucherTemplateById extends MBSCommand {
  static description = '获取优惠券模板列表：获取优惠券模板列表'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeVoucherTemplateById)

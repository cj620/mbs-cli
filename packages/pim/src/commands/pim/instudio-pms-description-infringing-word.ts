...
export default class PimInstudioPmsDescriptionInfringingWord extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsDescriptionInfringingWord)

...
export default class PimInstudioPmsGetExceptionList extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetExceptionList)

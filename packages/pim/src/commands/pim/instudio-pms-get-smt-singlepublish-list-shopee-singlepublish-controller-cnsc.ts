...
export default class PimInstudioPmsGetSmtSinglepublishListShopeeSinglepublishControllerCnsc extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetSmtSinglepublishListShopeeSinglepublishControllerCnsc)

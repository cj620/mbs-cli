...
export default class PimInstudioPmsGetDevelopmentProjectDiagram extends MBSCommand {
  static description = '获取项目创建以来一年内的销量趋势图数据：获取项目创建以来一年内的销量趋势图数据'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetDevelopmentProjectDiagram)

...
export default class PimInstudioPmsFindShopByPtNew extends MBSCommand {
  static description = '查询当前登陆人店铺信息排除直邮店铺：查询当前登陆人店铺信息排除直邮店铺'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindShopByPtNew)

...
export default class PimInstudioPmsFindCategoryNameByCategoryIdShopeeSinglepublishController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindCategoryNameByCategoryIdShopeeSinglepublishController)

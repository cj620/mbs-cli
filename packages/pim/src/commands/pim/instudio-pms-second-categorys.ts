...
export default class PimInstudioPmsSecondCategorys extends MBSCommand {
  static description = '开发中台的二级分类列表数据：开发中台的二级分类列表数据'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsSecondCategorys)

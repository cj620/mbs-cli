...
export default class PimInstudioPmsGetWalmartPublishCategoryNew extends MBSCommand {
  static description = '获取walmart刊登分类(新)：获取walmart刊登分类(新)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetWalmartPublishCategoryNew)

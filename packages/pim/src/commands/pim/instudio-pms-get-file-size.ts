...
export default class PimInstudioPmsGetFileSize extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetFileSize)

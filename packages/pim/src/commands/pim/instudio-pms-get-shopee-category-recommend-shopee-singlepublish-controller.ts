...
export default class PimInstudioPmsGetShopeeCategoryRecommendShopeeSinglepublishController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeCategoryRecommendShopeeSinglepublishController)

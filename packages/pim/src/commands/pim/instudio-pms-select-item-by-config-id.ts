...
export default class PimInstudioPmsSelectItemByConfigId extends MBSCommand {
  static description = '根据配置id查询出所有绑定的产品：根据配置id查询出所有绑定的产品'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsSelectItemByConfigId)

...
export default class PimInstudioPmsFindCategoryBySpuSmtSinglepublishController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindCategoryBySpuSmtSinglepublishController)

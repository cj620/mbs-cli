...
export default class PimInstudioPmsGetCategoryInfoDataTiktokSinglepublishGlobalController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetCategoryInfoDataTiktokSinglepublishGlobalController)

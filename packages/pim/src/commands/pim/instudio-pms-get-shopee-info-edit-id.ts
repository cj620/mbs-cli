...
export default class PimInstudioPmsGetShopeeInfoEditId extends MBSCommand {
  static description = '接口进行拉取信息：接口进行拉取信息'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeInfoEditId)

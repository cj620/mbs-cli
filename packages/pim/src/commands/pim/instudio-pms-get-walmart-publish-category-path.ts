...
export default class PimInstudioPmsGetWalmartPublishCategoryPath extends MBSCommand {
  static description = '获取walmart刊登分类路径(模糊查询)：获取walmart刊登分类路径(模糊查询)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetWalmartPublishCategoryPath)

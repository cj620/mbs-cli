...
export default class PimInstudioPmsFindShopByPtSpuOzonSinglepublishInfoController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindShopByPtSpuOzonSinglepublishInfoController)

...
export default class PimInstudioPmsExportMiddlePanelData extends MBSCommand {
  static description = '导出中台数据信息：导出中台数据信息'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsExportMiddlePanelData)

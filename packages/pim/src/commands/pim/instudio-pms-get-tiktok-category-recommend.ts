...
export default class PimInstudioPmsGetTiktokCategoryRecommend extends MBSCommand {
  static description = '获取推荐类目：获取推荐类目'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetTiktokCategoryRecommend)

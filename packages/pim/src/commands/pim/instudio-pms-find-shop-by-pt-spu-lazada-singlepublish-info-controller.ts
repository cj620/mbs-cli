...
export default class PimInstudioPmsFindShopByPtSpuLazadaSinglepublishInfoController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindShopByPtSpuLazadaSinglepublishInfoController)

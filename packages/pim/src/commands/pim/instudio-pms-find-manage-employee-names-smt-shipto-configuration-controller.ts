...
export default class PimInstudioPmsFindManageEmployeeNamesSmtShiptoConfigurationController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindManageEmployeeNamesSmtShiptoConfigurationController)

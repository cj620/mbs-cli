...
export default class PimInstudioPmsFindCategoryNameByCategoryIdLazadaSinglepublishInfoController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindCategoryNameByCategoryIdLazadaSinglepublishInfoController)

...
export default class PimInstudioPmsQueryHscodeByAttribute extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsQueryHscodeByAttribute)

...
export default class PimInstudioPmsFindCategoryNameByCategoryIdShopeeSinglepublishControllerCnsc extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindCategoryNameByCategoryIdShopeeSinglepublishControllerCnsc)

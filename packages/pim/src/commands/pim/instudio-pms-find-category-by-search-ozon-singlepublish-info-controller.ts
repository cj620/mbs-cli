...
export default class PimInstudioPmsFindCategoryBySearchOzonSinglepublishInfoController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindCategoryBySearchOzonSinglepublishInfoController)

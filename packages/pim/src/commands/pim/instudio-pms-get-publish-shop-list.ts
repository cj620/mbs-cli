...
export default class PimInstudioPmsGetPublishShopList extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetPublishShopList)

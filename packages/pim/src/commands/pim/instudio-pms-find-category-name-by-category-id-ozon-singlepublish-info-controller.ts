...
export default class PimInstudioPmsFindCategoryNameByCategoryIdOzonSinglepublishInfoController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindCategoryNameByCategoryIdOzonSinglepublishInfoController)

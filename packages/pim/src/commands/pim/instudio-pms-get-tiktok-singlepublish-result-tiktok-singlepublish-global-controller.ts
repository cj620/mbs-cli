...
export default class PimInstudioPmsGetTiktokSinglepublishResultTiktokSinglepublishGlobalController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetTiktokSinglepublishResultTiktokSinglepublishGlobalController)

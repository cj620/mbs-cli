...
export default class PimInstudioPmsGetSkuPurchaseInfo extends MBSCommand {
  static description = '查询SKU采购信息：查询SKU采购信息(源码无注释,按方法名推断)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetSkuPurchaseInfo)

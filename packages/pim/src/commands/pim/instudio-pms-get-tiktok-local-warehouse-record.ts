...
export default class PimInstudioPmsGetTiktokLocalWarehouseRecord extends MBSCommand {
  static description = '获取仓库：获取仓库'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetTiktokLocalWarehouseRecord)

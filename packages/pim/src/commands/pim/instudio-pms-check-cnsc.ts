...
export default class PimInstudioPmsCheckCnsc extends MBSCommand {
  static description = '判断是否是cnsc店铺：判断是否是cnsc店铺'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsCheckCnsc)

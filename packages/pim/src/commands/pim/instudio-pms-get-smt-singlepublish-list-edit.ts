...
export default class PimInstudioPmsGetSmtSinglepublishListEdit extends MBSCommand {
  static description = '获取编辑信息列表：获取编辑信息列表'

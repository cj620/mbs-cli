...
export default class PimInstudioPmsFindShopByPtShopeeSinglepublishController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindShopByPtShopeeSinglepublishController)

...
export default class PimInstudioPmsGetProductPics2 extends MBSCommand {
  static description = '获取商品池图片：获取商品池图片'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetProductPics2)

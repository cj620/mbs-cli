...
export default class PimInstudioPmsGetUrlInfo extends MBSCommand {
  static description = '根据产品id获取分类id：根据产品id获取分类id'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetUrlInfo)

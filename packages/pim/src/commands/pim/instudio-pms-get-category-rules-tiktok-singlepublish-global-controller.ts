...
export default class PimInstudioPmsGetCategoryRulesTiktokSinglepublishGlobalController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetCategoryRulesTiktokSinglepublishGlobalController)

...
export default class PimInstudioPmsFindItemSpecificsByCategoryIdOld extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindItemSpecificsByCategoryIdOld)

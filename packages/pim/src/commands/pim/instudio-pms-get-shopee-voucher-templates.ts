...
export default class PimInstudioPmsGetShopeeVoucherTemplates extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeVoucherTemplates)

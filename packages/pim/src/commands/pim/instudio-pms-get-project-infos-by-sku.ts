...
export default class PimInstudioPmsGetProjectInfosBySku extends MBSCommand {
  static description = '根据sku查询对应的海外仓备货计划：根据sku查询对应的海外仓备货计划'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetProjectInfosBySku)

...
export default class PimInstudioPmsGetCategoryInfoDataTiktokSinglepublishLocalController extends MBSCommand {
  static description = '获取分类属性：获取分类属性'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetCategoryInfoDataTiktokSinglepublishLocalController)

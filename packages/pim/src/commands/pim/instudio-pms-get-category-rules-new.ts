...
export default class PimInstudioPmsGetCategoryRulesNew extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetCategoryRulesNew)

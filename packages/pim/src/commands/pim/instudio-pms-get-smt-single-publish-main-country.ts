...
export default class PimInstudioPmsGetSmtSinglePublishMainCountry extends MBSCommand {
  static description = '自定义模板获取国家：自定义模板获取国家'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetSmtSinglePublishMainCountry)

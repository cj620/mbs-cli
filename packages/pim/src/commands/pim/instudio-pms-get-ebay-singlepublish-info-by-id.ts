...
export default class PimInstudioPmsGetEbaySinglepublishInfoById extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetEbaySinglepublishInfoById)

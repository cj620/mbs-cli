...
export default class PimInstudioPmsGetProductPicsTiktokSinglepublishGlobalController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetProductPicsTiktokSinglepublishGlobalController)

...
export default class PimInstudioPmsGetAliexpressCategoryQualifications extends MBSCommand {
  static description = '查询速卖通类目Qualifications：查询速卖通类目Qualifications(源码无注释,按方法名推断)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetAliexpressCategoryQualifications)

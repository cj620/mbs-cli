...
export default class PimInstudioPmsGetShopeeSinglepublishInfoByIdEdit extends MBSCommand {
  static description = '查询信息：查询信息'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeSinglepublishInfoByIdEdit)

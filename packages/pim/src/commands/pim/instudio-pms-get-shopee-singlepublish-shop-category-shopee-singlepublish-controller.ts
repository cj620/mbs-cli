...
export default class PimInstudioPmsGetShopeeSinglepublishShopCategoryShopeeSinglepublishController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeSinglepublishShopCategoryShopeeSinglepublishController)

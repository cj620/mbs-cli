...
export default class PimInstudioPmsFindPmsSkuBySpuLazadaSinglepublishInfoController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindPmsSkuBySpuLazadaSinglepublishInfoController)

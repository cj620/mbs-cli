...
export default class PimInstudioPmsGetShopeeCategoryRecommendShopeeSinglepublishControllerCnsc extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeCategoryRecommendShopeeSinglepublishControllerCnsc)

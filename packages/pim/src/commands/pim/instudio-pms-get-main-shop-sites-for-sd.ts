...
export default class PimInstudioPmsGetMainShopSitesForSd extends MBSCommand {
  static description = '查找店铺下站点：查找店铺下站点'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetMainShopSitesForSd)

...
export default class PimInstudioPmsGetSpuOudaiPicture extends MBSCommand {
  static description = '获取欧代图：获取欧代图'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetSpuOudaiPicture)

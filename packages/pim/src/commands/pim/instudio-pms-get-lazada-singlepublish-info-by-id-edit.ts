...
export default class PimInstudioPmsGetLazadaSinglepublishInfoByIdEdit extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetLazadaSinglepublishInfoByIdEdit)

...
export default class PimInstudioPmsGetAliexpressChoiceSinglePublishInfo extends MBSCommand {
  static description = '查询速卖通Choice单个刊登信息：查询速卖通Choice单个刊登信息(源码无注释,按方法名推断)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetAliexpressChoiceSinglePublishInfo)

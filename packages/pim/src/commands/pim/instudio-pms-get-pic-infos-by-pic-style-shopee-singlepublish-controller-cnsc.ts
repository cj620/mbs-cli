...
export default class PimInstudioPmsGetPicInfosByPicStyleShopeeSinglepublishControllerCnsc extends MBSCommand {
  static description = '获取套图：获取套图'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetPicInfosByPicStyleShopeeSinglepublishControllerCnsc)

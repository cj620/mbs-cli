...
export default class PimInstudioPmsFindCategoryBySpuEbaySinglepublishInfoController extends MBSCommand {
  static description = '根据SPU查询分类：根据SPU查询分类'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindCategoryBySpuEbaySinglepublishInfoController)

...
export default class PimInstudioPmsFindShopVoucher extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindShopVoucher)

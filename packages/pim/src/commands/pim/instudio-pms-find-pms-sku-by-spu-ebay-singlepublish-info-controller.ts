...
export default class PimInstudioPmsFindPmsSkuBySpuEbaySinglepublishInfoController extends MBSCommand {
  static description = '根据spu查询sku：根据spu查询sku'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindPmsSkuBySpuEbaySinglepublishInfoController)

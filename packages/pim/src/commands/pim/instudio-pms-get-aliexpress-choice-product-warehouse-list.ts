...
export default class PimInstudioPmsGetAliexpressChoiceProductWarehouseList extends MBSCommand {
  static description = '查询速卖通Choice商品仓库列表：查询速卖通Choice商品仓库列表(源码无注释,按方法名推断)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetAliexpressChoiceProductWarehouseList)

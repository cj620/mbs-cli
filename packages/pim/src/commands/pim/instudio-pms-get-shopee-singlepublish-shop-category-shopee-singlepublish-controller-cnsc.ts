...
export default class PimInstudioPmsGetShopeeSinglepublishShopCategoryShopeeSinglepublishControllerCnsc extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeSinglepublishShopCategoryShopeeSinglepublishControllerCnsc)

...
export default class PimInstudioPmsGetTiktokSinglepublishResultTiktokSinglepublishLocalController extends MBSCommand {
  static description = '获取刊登明细：获取刊登明细'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetTiktokSinglepublishResultTiktokSinglepublishLocalController)

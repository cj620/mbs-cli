...
export default class PimInstudioPmsGetYandexPublishConfirmList extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetYandexPublishConfirmList)

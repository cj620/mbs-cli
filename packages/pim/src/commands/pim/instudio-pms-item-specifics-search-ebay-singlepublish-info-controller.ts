...
export default class PimInstudioPmsItemSpecificsSearchEbaySinglepublishInfoController extends MBSCommand {
  static description = '条目Specifics搜索：条目Specifics搜索(源码无注释,按方法名推断)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsItemSpecificsSearchEbaySinglepublishInfoController)

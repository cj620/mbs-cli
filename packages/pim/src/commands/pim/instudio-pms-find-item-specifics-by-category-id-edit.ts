...
export default class PimInstudioPmsFindItemSpecificsByCategoryIdEdit extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindItemSpecificsByCategoryIdEdit)

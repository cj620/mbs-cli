...
export default class PimInstudioPmsGetWalmartPublishConfirmListV3 extends MBSCommand {
  static description = '获取walmart刊登任务列表(最新)：获取walmart刊登任务列表(最新)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetWalmartPublishConfirmListV3)

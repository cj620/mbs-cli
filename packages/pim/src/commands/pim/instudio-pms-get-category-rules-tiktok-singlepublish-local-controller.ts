...
export default class PimInstudioPmsGetCategoryRulesTiktokSinglepublishLocalController extends MBSCommand {
  static description = '获取分类规则：获取分类规则'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetCategoryRulesTiktokSinglepublishLocalController)

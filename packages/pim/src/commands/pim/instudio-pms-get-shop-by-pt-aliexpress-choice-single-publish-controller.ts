...
export default class PimInstudioPmsGetShopByPtAliexpressChoiceSinglePublishController extends MBSCommand {
  static description = '查询店铺名称列表：查询店铺名称列表(源码无注释,按方法名推断)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopByPtAliexpressChoiceSinglePublishController)

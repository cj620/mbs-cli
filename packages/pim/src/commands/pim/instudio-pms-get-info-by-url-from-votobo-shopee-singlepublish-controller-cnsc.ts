...
export default class PimInstudioPmsGetInfoByUrlFromVotoboShopeeSinglepublishControllerCnsc extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetInfoByUrlFromVotoboShopeeSinglepublishControllerCnsc)

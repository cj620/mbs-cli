...
export default class PimInstudioPmsGetMsrList extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetMsrList)

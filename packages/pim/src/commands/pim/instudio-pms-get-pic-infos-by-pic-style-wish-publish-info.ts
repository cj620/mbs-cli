...
export default class PimInstudioPmsGetPicInfosByPicStyleWishPublishInfo extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetPicInfosByPicStyleWishPublishInfo)

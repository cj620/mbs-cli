...
export default class PimInstudioPmsGetMainPicsBySpuStyleWishPublishInfo extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetMainPicsBySpuStyleWishPublishInfo)

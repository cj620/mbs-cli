...
export default class PimInstudioPmsGetWalmartPublishCategory extends MBSCommand {
  static description = '获取walmart刊登分类：获取walmart刊登分类'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetWalmartPublishCategory)

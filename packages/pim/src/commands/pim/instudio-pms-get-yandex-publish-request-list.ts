...
export default class PimInstudioPmsGetYandexPublishRequestList extends MBSCommand {
  static description = '获取yandex刊登任务列表：获取yandex刊登任务列表'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetYandexPublishRequestList)

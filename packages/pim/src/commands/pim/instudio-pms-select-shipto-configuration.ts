...
export default class PimInstudioPmsSelectShiptoConfiguration extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsSelectShiptoConfiguration)

...
export default class PimInstudioPmsFindCategoryBySearchEbaySinglepublishInfoController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindCategoryBySearchEbaySinglepublishInfoController)

...
export default class PimInstudioPmsGetMainPicsBySpuStyleShopeeSinglepublishControllerCnsc extends MBSCommand {
  static description = '获取文件大小：获取文件大小'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetMainPicsBySpuStyleShopeeSinglepublishControllerCnsc)

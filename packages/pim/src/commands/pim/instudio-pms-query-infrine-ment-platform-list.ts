...
export default class PimInstudioPmsQueryInfrineMentPlatformList extends MBSCommand {
  static description = '获取店铺侵权列表：获取店铺侵权列表'

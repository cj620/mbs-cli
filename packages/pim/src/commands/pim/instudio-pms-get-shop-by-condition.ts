...
export default class PimInstudioPmsGetShopByCondition extends MBSCommand {
  static description = '按条件查询店铺：按条件查询店铺(源码无注释,按方法名推断)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopByCondition)

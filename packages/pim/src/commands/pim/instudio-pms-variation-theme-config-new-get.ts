...
export default class PimInstudioPmsVariationThemeConfigNewGet extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsVariationThemeConfigNewGet)

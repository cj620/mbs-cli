...
export default class PimInstudioPmsGetPictureList extends MBSCommand {
  static description = '美客多-获取图片：美客多-获取图片'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetPictureList)

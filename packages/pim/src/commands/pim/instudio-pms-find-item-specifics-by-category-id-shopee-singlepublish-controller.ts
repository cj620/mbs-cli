...
export default class PimInstudioPmsFindItemSpecificsByCategoryIdShopeeSinglepublishController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindItemSpecificsByCategoryIdShopeeSinglepublishController)

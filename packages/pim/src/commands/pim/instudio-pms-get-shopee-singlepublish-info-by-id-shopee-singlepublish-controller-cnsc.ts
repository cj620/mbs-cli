...
export default class PimInstudioPmsGetShopeeSinglepublishInfoByIdShopeeSinglepublishControllerCnsc extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeSinglepublishInfoByIdShopeeSinglepublishControllerCnsc)

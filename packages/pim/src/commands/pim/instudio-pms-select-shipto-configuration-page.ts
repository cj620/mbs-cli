...
export default class PimInstudioPmsSelectShiptoConfigurationPage extends MBSCommand {
  static description = '查询shipto列表：查询shipto列表'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsSelectShiptoConfigurationPage)

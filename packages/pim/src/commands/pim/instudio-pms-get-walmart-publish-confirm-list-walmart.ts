...
export default class PimInstudioPmsGetWalmartPublishConfirmListWalmart extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetWalmartPublishConfirmListWalmart)

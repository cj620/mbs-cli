...
export default class PimInstudioPmsGetLogisticsByShopNameShopeeSinglepublishControllerCnsc extends MBSCommand {
  static description = '根据店铺获取物流模板：根据店铺获取物流模板'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetLogisticsByShopNameShopeeSinglepublishControllerCnsc)

...
export default class PimInstudioPmsFindSmtCategorySurgeword extends MBSCommand {
  static description = '根据类别查找流量词：根据类别查找流量词'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindSmtCategorySurgeword)

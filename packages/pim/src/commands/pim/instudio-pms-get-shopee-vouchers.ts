...
export default class PimInstudioPmsGetShopeeVouchers extends MBSCommand {
  static description = '获取优惠券列表：获取优惠券列表'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeVouchers)

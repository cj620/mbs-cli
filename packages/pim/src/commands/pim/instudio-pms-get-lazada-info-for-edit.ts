...
export default class PimInstudioPmsGetLazadaInfoForEdit extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetLazadaInfoForEdit)

...
export default class PimInstudioPmsGetProjectListHwcDevelopmentProject extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetProjectListHwcDevelopmentProject)

...
export default class PimInstudioPmsGetPicInfosByPicStyleSmtSinglepublishController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetPicInfosByPicStyleSmtSinglepublishController)

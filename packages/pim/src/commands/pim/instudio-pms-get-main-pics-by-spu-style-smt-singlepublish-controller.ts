...
export default class PimInstudioPmsGetMainPicsBySpuStyleSmtSinglepublishController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetMainPicsBySpuStyleSmtSinglepublishController)

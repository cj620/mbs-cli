...
export default class PimInstudioPmsGetWalmartCategoryList extends MBSCommand {
  static description = '获取walmart刊登分类(模糊查询)：获取walmart刊登分类(模糊查询)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetWalmartCategoryList)

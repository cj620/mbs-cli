...
export default class PimInstudioPmsDevelopmentProjectList extends MBSCommand {
  static description = '开发项目列表：开发项目列表'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsDevelopmentProjectList)

...
export default class PimInstudioPmsFindDevelopConsumer extends MBSCommand {
  static description = '通过登录名获取创建的开发任务：通过登录名获取创建的开发任务'

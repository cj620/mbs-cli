...
export default class PimInstudioPmsFindShiptoForBatchPrice extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindShiptoForBatchPrice)

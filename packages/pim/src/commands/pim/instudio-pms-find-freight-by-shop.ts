...
export default class PimInstudioPmsFindFreightByShop extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindFreightByShop)

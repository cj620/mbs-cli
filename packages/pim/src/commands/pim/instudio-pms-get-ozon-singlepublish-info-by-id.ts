...
export default class PimInstudioPmsGetOzonSinglepublishInfoById extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetOzonSinglepublishInfoById)

...
export default class PimInstudioPmsGetCategoryProperties extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetCategoryProperties)

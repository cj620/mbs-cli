...
export default class PimInstudioPmsYlExport extends MBSCommand {
  static description = '查找有几套图：查找有几套图'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsYlExport)

...
export default class PimInstudioPmsGetShopeeCategoryRecommend2 extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopeeCategoryRecommend2)

...
export default class PimInstudioPmsGetSkuVariationInfo extends MBSCommand {
  static description = 'SKU组套信息下拉：SKU组套信息下拉'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetSkuVariationInfo)

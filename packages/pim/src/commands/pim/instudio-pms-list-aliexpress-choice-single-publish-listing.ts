...
export default class PimInstudioPmsListAliexpressChoiceSinglePublishListing extends MBSCommand {
  static description = '列表速卖通Choice单个刊登刊登：列表速卖通Choice单个刊登刊登(源码无注释,按方法名推断)'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsListAliexpressChoiceSinglePublishListing)

...
export default class PimInstudioPmsGetLazadaSinglepublishList extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetLazadaSinglepublishList)

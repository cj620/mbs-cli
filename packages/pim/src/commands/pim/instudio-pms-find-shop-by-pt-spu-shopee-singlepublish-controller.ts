...
export default class PimInstudioPmsFindShopByPtSpuShopeeSinglepublishController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindShopByPtSpuShopeeSinglepublishController)

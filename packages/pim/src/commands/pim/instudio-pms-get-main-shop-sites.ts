...
export default class PimInstudioPmsGetMainShopSites extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetMainShopSites)

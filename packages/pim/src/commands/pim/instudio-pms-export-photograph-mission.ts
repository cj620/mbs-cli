...
export default class PimInstudioPmsExportPhotographMission extends MBSCommand {
  static description = '导出拍照任务查询列表：导出拍照任务查询列表'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsExportPhotographMission)

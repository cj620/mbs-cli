...
export default class PimInstudioPmsItemSpecificsSearchLazadaSinglepublishInfoController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsItemSpecificsSearchLazadaSinglepublishInfoController)

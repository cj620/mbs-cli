...
export default class PimInstudioPmsGetProductPicsTiktokSinglepublishLocalController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetProductPicsTiktokSinglepublishLocalController)

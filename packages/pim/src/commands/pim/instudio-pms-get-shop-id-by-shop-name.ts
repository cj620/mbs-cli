...
export default class PimInstudioPmsGetShopIdByShopName extends MBSCommand {
  static description = '根据店铺获取merchantid下的所有店铺名：根据店铺获取merchantid下的所有店铺名'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetShopIdByShopName)

...
export default class PimInstudioPmsDevelopmentProjectDetail extends MBSCommand {
  static description = '开发项目详情：开发项目详情'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsDevelopmentProjectDetail)

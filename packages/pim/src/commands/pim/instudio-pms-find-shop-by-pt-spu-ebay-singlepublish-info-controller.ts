...
export default class PimInstudioPmsFindShopByPtSpuEbaySinglepublishInfoController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindShopByPtSpuEbaySinglepublishInfoController)

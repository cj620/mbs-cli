...
export default class PimInstudioPmsFindItemSpecificsByCategoryIdOzonSinglepublishInfoController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindItemSpecificsByCategoryIdOzonSinglepublishInfoController)

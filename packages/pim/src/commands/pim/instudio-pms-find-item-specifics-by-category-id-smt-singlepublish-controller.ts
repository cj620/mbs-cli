...
export default class PimInstudioPmsFindItemSpecificsByCategoryIdSmtSinglepublishController extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindItemSpecificsByCategoryIdSmtSinglepublishController)

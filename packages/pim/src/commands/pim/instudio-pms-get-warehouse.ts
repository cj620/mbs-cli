...
export default class PimInstudioPmsGetWarehouse extends MBSCommand {
  static description = '查询仓库：查询仓库(源码无注释,按方法名推断)'

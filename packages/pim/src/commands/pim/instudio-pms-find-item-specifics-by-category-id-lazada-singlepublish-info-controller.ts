...
export default class PimInstudioPmsFindItemSpecificsByCategoryIdLazadaSinglepublishInfoController extends MBSCommand {
  static description = '图片上传：图片上传'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsFindItemSpecificsByCategoryIdLazadaSinglepublishInfoController)

...
export default class PimInstudioPmsGetGlobalWarehouse extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetGlobalWarehouse)

...
export default class PimInstudioPmsGetSpuImageWalmart extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetSpuImageWalmart)

...
export default class PimInstudioPmsGetAmazonPublishConfirmList extends MBSCommand {
  static description = '获取Amazon刊登任务列表：获取Amazon刊登任务列表'
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetAmazonPublishConfirmList)

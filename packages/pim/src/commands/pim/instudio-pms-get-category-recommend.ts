...
export default class PimInstudioPmsGetCategoryRecommend extends MBSCommand {
  ...
  async run(): Promise<void> {
    const { flags } = await this.parse(PimInstudioPmsGetCategoryRecommend)

...
/**
 * Preserves the published `mbs product erp-product-product` read-only contract from CLI 0.1.58.
 *
 * The command keeps the historical flags and sends requests to `/erpProduct/erpProduct/product/product`

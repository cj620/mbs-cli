...
export const actionSchema = z.object({
  ...
  requestBodyMode: z.enum(['NONE', 'JSON', 'FORM_URLENCODED', 'MULTIPART', 'TEXT', 'XML', 'BINARY']).optional(),
  requestMediaType: z.string().max(255).optional(),
  requestCharset: z.string().max(32).optional(),

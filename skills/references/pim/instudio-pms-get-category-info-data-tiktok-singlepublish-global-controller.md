...
# mbs pim instudio-pms-get-category-info-data-tiktok-singlepublish-global-controller
...
| `obj.obj.product_properties` | string | 商品属性（前端推断字段）。前端使用：是（前端推断，行号待核实） | - |

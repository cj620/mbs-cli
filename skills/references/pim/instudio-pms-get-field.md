...
# mbs pim instudio-pms-get-field

获取配置的color,size 字段：获取配置的color,size 字段

## 用法

```bash
mbs pim instudio-pms-get-field --type <string> --site <string> --mainCategory <string> --productType <string>
```

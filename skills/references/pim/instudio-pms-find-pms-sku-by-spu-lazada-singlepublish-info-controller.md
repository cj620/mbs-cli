...
# mbs pim instudio-pms-find-pms-sku-by-spu-lazada-singlepublish-info-controller

根据spu查询sku：根据spu查询sku

## 用法

```bash
mbs pim instudio-pms-find-pms-sku-by-spu-lazada-singlepublish-info-controller [--name <string>] [--site <string>] [--siteList <array<string>>] [--vtype <string>] [--spu <string>] [--categoryid <string>] [--id <integer>] [--idList <array<integer>>] [--attributeName <string>] [--searchParam <string>] [--title <string>] [--shopname <string>] [--shopList <array<string>>] [--empName <string>] [--itemId <string>] [--oper <string>] [--isRefresh <integer>] [--createby <string>] [--erpSpu <string>] [--listId <integer>] [--ids <array<integer>>] [--isCompulsory <integer>] [--keywords <array<string>>] [--total <integer>] [--calcPriceFlag <integer>] [--isTranslate <integer>] [--copyId <integer>] [--timeOccur <string>]
```

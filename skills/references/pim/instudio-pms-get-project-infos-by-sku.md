# mbs pim instudio-pms-get-project-infos-by-sku

根据sku查询对应的海外仓备货计划：根据sku查询对应的海外仓备货计划

## 用法

```bash
mbs pim instudio-pms-get-project-infos-by-sku [--currentPage <integer>] [--dateCodeGeq <string>] [--dateCodeLeq <string>] [--logisticsType <string>] [--nameLike <string>] [--nowScheduleType <string>] [--pageSize <integer>] [--sku <string>] [--sortValue <string>] [--warehouseTypeId <string>] [--skuList <array<string>>] [--start <integer>] [--end <integer>] [--createby <string>] [--managerEmployeeList <array<string>>] [--flag <boolean>] [--projectIdList <array<integer>>] [--companyid <integer>] [--shopList <array<string>>] [--departFlag <integer>]
```

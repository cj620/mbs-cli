...
# mbs pim instudio-pms-get-shop-responsible-person-list
...
```bash
mbs pim instudio-pms-get-shop-responsible-person-list [--mainShop <string>] [--siteList <array<string>>] [--syncType <string>]
```

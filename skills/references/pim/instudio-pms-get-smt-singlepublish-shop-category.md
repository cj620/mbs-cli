...
# mbs pim instudio-pms-get-smt-singlepublish-shop-category
...
```bash
mbs pim instudio-pms-get-smt-singlepublish-shop-category [--id <integer>] [--shopname <string>] [--categoryId <string>] [--categoryName <string>] [--parentCategoryId <string>] [--categoryLevel <integer>] [--leafCategory <integer>] [--ordernum <integer>] [--createby <string>] [--createtime <string>]
```

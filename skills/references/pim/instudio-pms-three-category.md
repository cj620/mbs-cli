# mbs pim instudio-pms-three-category

开发中台的三级分类列表数据：开发中台的三级分类列表数据

## 用法

```bash
mbs pim instudio-pms-three-category [--times <string>] [--firstCategoryName <string>] [--page <integer>] [--pageSize <integer>] [--startIndex <integer>] [--firstCategoryList <array<string>>] [--secondCategoryName <string>] [--secondCategoryList <array<string>>] [--companyId <integer>] [--exportTimeList <array<string>>]
```

# mbs pim instudio-pms-get-spu-image-walmart
...
```bash
mbs pim instudio-pms-get-spu-image-walmart [--dataType <integer>] [--shopName <string>] [--mainCategory <string>] [--site <string>] [--parentCategoryId <string>] [--categoryLevel <integer>] [--categoryName <string>] [--spu <string>] [--productType <string>] [--singleFlag <string>] [--queryFlag <string>] [--queryCategory <string>] [--queryCategoryList <array<string>>] [--spuList <array<string>>] [--status <integer>] [--createBy <string>] [--startDate <string>] [--endDate <string>] [--sku <string>] [--pricingChannel <string>] [--page <integer>] [--pageSize <integer>] [--startIndex <integer>] [--shopIdList <array<string>>] [--fieldName <string>] [--required <integer>] [--shopManagerList <array<string>>] [--id <string>] [--requestId <string>] [--requestIdList <array<string>>] [--sites <array<string>>] [--title <string>] [--orderType <string>] [--orderFiled <string>] [--riskLevel <integer>] [--defaultTemplates <array<string>>]
```

...
# mbs pim instudio-pms-get-main-category

获取可刊登的大类列表：获取可刊登的大类列表

## 用法

```bash
mbs pim instudio-pms-get-main-category [--shopName <string>]
```
...
|---|---|---|---|---|---|---|
| `shopName` | shopName | query | string | 否 | - | 店铺名称（字段名推断,语义待核实） |

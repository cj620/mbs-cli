# mbs pim instudio-pms-variation-theme-config-new-get
...
```bash
mbs pim instudio-pms-variation-theme-config-new-get [--site <string>] [--mainCategory <string>] [--shopName <string>] [--productType <string>] [--requiredField <string>] [--color <string>] [--size <string>] [--requiredFields <array<string>>] [--productTypeId <integer>] [--variationTheme <string>] [--requestId <string>]
```

...
# mbs pim instudio-pms-get-category-rules-new
...
| `obj.obj.is_required` | string | 是否必填（前端推断字段）。前端使用：是（前端推断，行号待核实） | - |

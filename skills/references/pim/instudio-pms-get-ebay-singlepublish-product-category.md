...
# mbs pim instudio-pms-get-ebay-singlepublish-product-category
...
```bash
mbs pim instudio-pms-get-ebay-singlepublish-product-category [--id <integer>] [--site <string>] [--categoryId <string>] [--categoryName <string>] [--categoryNameAll <string>] [--parentCategoryId <string>] [--categoryLevel <integer>] [--leafCategory <integer>] [--bestOffer <integer>] [--createby <string>] [--createtime <string>] [--variationsEnabled <integer>] [--variationsEnabledCn <string>]
```
...
| `bestOffer` | bestOffer | body | integer | 否 | - | 1:true 有议价 else 0 |

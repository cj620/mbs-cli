...
# mbs pim instudio-pms-development-project-detail
...
```bash
mbs pim instudio-pms-development-project-detail [--createBy <string>] [--developer <string>] [--startDate <string>] [--endDate <string>] [--spu <string>] [--projectName <string>] [--projectId <string>] [--createList <array<string>>] [--projectIds <array<string>>] [--spuList <array<string>>] [--id <integer>] [--projectContent <string>] [--page <integer>] [--pageSize <integer>] [--startIndex <integer>] [--bigChief <string>] [--isPublic <integer>] [--projectType <integer>] [--saleLevel <string>] [--companyId <string>]
```

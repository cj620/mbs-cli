...
# mbs pim instudio-pms-get-ozon-warehouse
...
```bash
mbs pim instudio-pms-get-ozon-warehouse [--name <string>] [--site <string>] [--vtype <string>] [--spu <string>] [--categoryid <string>] [--parentCategoryid <string>] [--id <integer>] [--attributeName <string>] [--searchParam <string>] [--title <string>] [--shopname <string>] [--empName <string>] [--picStyle <string>] [--idList <array<integer>>] [--isTranslate <integer>] [--scene <string>]
```

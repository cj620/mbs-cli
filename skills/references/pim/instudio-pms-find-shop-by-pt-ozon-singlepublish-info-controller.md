# mbs pim instudio-pms-find-shop-by-pt-ozon-singlepublish-info-controller
...
```bash
mbs pim instudio-pms-find-shop-by-pt-ozon-singlepublish-info-controller --pt <string>
```

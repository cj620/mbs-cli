...
# mbs pim instudio-pms-find-publish-shop-names
...
```bash
mbs pim instudio-pms-find-publish-shop-names [--queryType <string>] [--level <integer>] [--parentCategoryId <integer>] [--keyWord <string>] [--categoryId <integer>] [--shopName <string>] [--shopNames <array<string>>] [--description <string>] [--shopsSplice <string>] [--erpSpu <string>] [--erpSku <string>] [--platformId <integer>] [--picStyle <string>] [--picQueryType <string>] [--descriptionPics <array<string>>] [--selectTypes <array<integer>>] [--selectType <integer>] [--operId <integer>] [--publishSkuList <array<object>>] [--listId <string>] [--listIds <array<string>>] [--findPropertiesBySkus <string>] [--moneyRate <number>]
```

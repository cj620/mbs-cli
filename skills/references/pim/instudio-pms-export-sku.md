...
# mbs pim instudio-pms-export-sku

导出walmart刊登SKU：导出walmart刊登SKU

## 用法

```bash
mbs pim instudio-pms-export-sku [--teamManagerList <array<string>>] [--site <string>] [--shopName <string>] [--shopId <string>] [--spu <string>] [--categoryName <string>] [--displayFieldFlag <integer>] [--variantAttributeNameList <array<string>>] [--page <integer>] [--pageSize <integer>] [--startIndex <integer>] [--shopManagerList <array<string>>] [--spuList <array<string>>] [--status <integer>] [--createBy <string>] [--startDate <string>] [--endDate <string>] [--requestIds <array<string>>] [--firstCategoryName <string>] [--secondCategoryName <string>]
```

...
# mbs pim instudio-pms-get-field-config

根据选择的变体属性值, 获取对应的字段配置信息：根据选择的变体属性值, 获取对应的字段配置信息

## 用法

```bash
mbs pim instudio-pms-get-field-config [--teamManagerList <array<string>>] [--site <string>] [--shopName <string>] [--shopId <string>] [--spu <string>] [--categoryName <string>] [--displayFieldFlag <integer>] [--variantAttributeNameList <array<string>>] [--page <integer>] [--pageSize <integer>] [--startIndex <integer>] [--shopManagerList <array<string>>] [--spuList <array<string>>] [--status <integer>] [--createBy <string>] [--startDate <string>] [--endDate <string>] [--requestIds <array<string>>] [--firstCategoryName <string>] [--secondCategoryName <string>]
```

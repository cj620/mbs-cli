...
# mbs pim instudio-pms-find-pms-sku-by-spu-ebay-singlepublish-info-controller
...
```bash
mbs pim instudio-pms-find-pms-sku-by-spu-ebay-singlepublish-info-controller [--name <string>] [--site <string>] [--vtype <string>] [--spu <string>] [--categoryid <string>] [--id <integer>] [--attributeName <string>] [--searchParam <string>] [--title <string>] [--shopname <string>] [--empName <string>] [--picStyle <string>] [--idList <array<integer>>] [--siteList <array<object>>] [--isTranslate <integer>]
```

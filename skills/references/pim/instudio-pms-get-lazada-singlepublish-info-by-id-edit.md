...
# mbs pim instudio-pms-get-lazada-singlepublish-info-by-id-edit
...
```bash
mbs pim instudio-pms-get-lazada-singlepublish-info-by-id-edit [--name <string>] [--site <string>] [--siteList <array<string>>] [--vtype <string>] [--spu <string>] [--categoryid <string>] [--id <integer>] [--idList <array<integer>>] [--attributeName <string>] [--searchParam <string>] [--title <string>] [--shopname <string>] [--shopList <array<string>>] [--empName <string>] [--itemId <string>] [--oper <string>] [--isRefresh <integer>] [--createby <string>] [--erpSpu <string>] [--listId <integer>] [--ids <array<integer>>] [--isCompulsory <integer>] [--keywords <array<string>>] [--total <integer>] [--calcPriceFlag <integer>] [--isTranslate <integer>] [--copyId <integer>] [--timeOccur <string>]
```

...
# mbs pim instudio-pms-get-exception-list
...
```bash
mbs pim instudio-pms-get-exception-list [--sku <string>] [--status <integer>] [--msgType <integer>] [--userId <integer>] [--flag <string>] [--startDate <string>] [--endDate <string>] [--developer <string>] [--buyer <string>] [--manageEmployeeNames <array<string>>]
```

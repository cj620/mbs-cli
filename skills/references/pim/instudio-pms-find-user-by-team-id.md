# mbs pim instudio-pms-find-user-by-team-id

按团队ID查询用户：按团队ID查询用户(源码无注释,按方法名推断)

## 用法

```bash
mbs pim instudio-pms-find-user-by-team-id --teamId <string>
```
...
|---|---|---|---|---|---|---|
| `teamId` | teamId | query | string | 是 | - | 团队ID（字段名推断,语义待核实） |

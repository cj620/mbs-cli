...
# mbs pim instudio-pms-get-walmart-category-list

获取walmart刊登分类(模糊查询)：获取walmart刊登分类(模糊查询)

## 用法

```bash
mbs pim instudio-pms-get-walmart-category-list [--teamManagerList <array<string>>] [--site <string>] [--shopName <string>] [--shopId <string>] [--spu <string>] [--categoryName <string>] [--displayFieldFlag <integer>] [--variantAttributeNameList <array<string>>] [--page <integer>] [--pageSize <integer>] [--startIndex <integer>] [--shopManagerList <array<string>>] [--spuList <array<string>>] [--status <integer>] [--createBy <string>] [--startDate <string>] [--endDate <string>] [--requestIds <array<string>>] [--firstCategoryName <string>] [--secondCategoryName <string>]
```

...
# mbs pim instudio-pms-get-global-warehouse
...
| `obj.obj[].warehouseInventory` | integer | 仓库库存（字段名推断,语义待核实）。前端使用：待核实 | - |
| `obj.obj[].warehouseId` | string | 仓库ID（字段名推断,语义待核实）。前端使用：待核实 | - |

...
# mbs pim instudio-pms-query-sku
...
```bash
mbs pim instudio-pms-query-sku [--index <string>] [--sku <string>] [--spu <string>] [--categoryId <string>] [--tagId <string>] [--brandId <string>] [--productname <string>] [--createoper <string>] [--createtimestart <string>] [--createtimeend <string>] [--companyname <string>] --warehouseid <integer> [--positionmname <string>] --skustatus <integer> --orderby <integer>
```

# mbs pim instudio-pms-get-walmart-shop-list

获取walmart店铺下拉：获取walmart店铺下拉

## 用法

```bash
mbs pim instudio-pms-get-walmart-shop-list [--pageSize <integer>] [--currentPage <integer>] [--startIndex <integer>] [--exportFlag <integer>] [--teamManger <array<string>>] [--directorList <array<integer>>] [--managerList <array<integer>>] [--shopManagerList <array<integer>>] [--siteList <array<string>>] [--shopNameList <array<string>>] [--keyWord <string>] [--autoPublishFlag <integer>]
```

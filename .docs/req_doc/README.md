...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `20260811-[RELEASE]建立1.0.0长期维护分支` | RELEASE | 将当前功能分支改名并建立为独立 `1.0.0` 长期维护线；只推送 Git 分支，不合并 master、不发布 npm | 🧪 待验收：V3 本地验证通过，正在提交并推送 `origin/1.0.0` | Codex | [`./20260811-[RELEASE]建立1.0.0长期维护分支/`](./20260811-[RELEASE]建立1.0.0长期维护分支/) |

...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `20260904-[RELEASE]发布1.1.1维护版本` | RELEASE / SECURITY | 提交 current-user 请求头修复并发布 npm `maintenance-1=1.1.1`；保持 `latest` 不变 | 🚧 发布成功 / 审计收尾中：分支 CI、Release、dist-tag、官方包与 Skill 验证通过，待审计提交 CI | Codex（当前执行者） | [`./20260904-[RELEASE]发布1.1.1维护版本/`](./20260904-[RELEASE]发布1.1.1维护版本/) |

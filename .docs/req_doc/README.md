...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `20260907-[RELEASE]发布1.1.3维护版本` | RELEASE / SECURITY | 提交 CLI 扫码登录闭环与认证边界修复；仅更新 npm `maintenance-1`，保持 `latest` 不变 | 🚧 执行中：功能提交 `e14ba10` 已推送，CI `34080466259` 成功；准备 1.1.3 版本提交 | Codex | [`./20260907-[RELEASE]发布1.1.3维护版本/`](./20260907-[RELEASE]发布1.1.3维护版本/) |

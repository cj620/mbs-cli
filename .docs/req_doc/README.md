...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `20260811-[RELEASE]建立1.0.0长期维护分支` | RELEASE | 将当前功能分支建立为独立 `1.0.0` 维护线，并通过 npm `maintenance-1` 发布而不改变 `latest` 或 master | 🚧 执行中：Git 分支及 CI 已交付，正在建立 maintenance-1 发布保护、README 和 npm 交付 | Codex | [`./20260811-[RELEASE]建立1.0.0长期维护分支/`](./20260811-[RELEASE]建立1.0.0长期维护分支/) |

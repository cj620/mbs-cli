...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `20260921-[RELEASE]发布1.1.7维护版本` | RELEASE / L3 | 将流式非 2xx 响应安全物化修复发布为 npm 1.1.7，并依次更新 `maintenance-1` 与 `latest`；每个远程阶段受 CI、Release、registry 和官方包验证门禁保护 | 🚧 执行中：目标版本/标签不存在，进入发布前 V3 验证 | Codex | [`./20260921-[RELEASE]发布1.1.7维护版本/`](./20260921-[RELEASE]发布1.1.7维护版本/) |

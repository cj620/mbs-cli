...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `20260908-[RELEASE]发布1.1.5维护版本` | RELEASE / SECURITY | 发布业务 500 不再误触发认证刷新；仅更新 npm `maintenance-1`，保持 `latest` 不变 | 🚧 执行中：功能提交及 CI 已通过，正在执行版本提交、标签与 npm 核验 | Codex | [`./20260908-[RELEASE]发布1.1.5维护版本/`](./20260908-[RELEASE]发布1.1.5维护版本/) |

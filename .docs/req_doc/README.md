...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `20260918-[RELEASE]发布1.1.6维护版本` | RELEASE / L3 | 发布参数依赖自动解析、明确数据库目标直达查询、可恢复批量查询与流式 Excel 导出；仅更新 npm `maintenance-1` | ✅ 已完成 / 已发布：323 项测试、14 包构建、两次分支 CI、Release、dist-tag 与官方包/Skill 核验通过；`latest` 未变 | 2026-09-18 | [`./20260918-[RELEASE]发布1.1.6维护版本/`](./20260918-[RELEASE]发布1.1.6维护版本/) |

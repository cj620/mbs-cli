...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `20260904-[RELEASE]发布1.1.1维护版本` | RELEASE / SECURITY | 提交 current-user 请求头修复并发布 npm `maintenance-1=1.1.1`；保持 `latest` 不变 | 🚧 执行中：发布前 V3 全部通过，正在提交并推送功能修复 | Codex（当前执行者） | [`./20260904-[RELEASE]发布1.1.1维护版本/`](./20260904-[RELEASE]发布1.1.1维护版本/) |

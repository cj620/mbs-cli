...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `20260812-[BUG]修复语义召回服务路由` | BUG / RELEASE | 恢复 find/describe 正式地址中的 `/cli/cli-service` 服务层，升级并发布 npm `1.0.1` 到 `maintenance-1`，不移动 `latest` | 🚀 待远程门禁：本地 V3 已通过，准备提交推送并等待分支 CI | Codex | [`./20260812-[BUG]修复语义召回服务路由/`](./20260812-[BUG]修复语义召回服务路由/) |

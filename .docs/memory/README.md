...
| `RELEASE-LINE-1X` | 1.0.0 长期维护分支 | `origin/1.0.0` 独立于 master；npm `maintenance-1=1.0.3` 已发布且 `latest` 保持 `0.1.58` | 全仓库、`packages/cli`、CI | `20260814-[RELEASE]发布1.0.3维护版本` | 已发布并完成官方源核验 | [`./topics/1.0.0长期维护分支.md`](./topics/1.0.0长期维护分支.md) | 2026-08-14 / `ee9c017` / `maintenance-1-v1.0.3` |

...
| `RELEASE-LINE-1X` | 1.0.0 长期维护分支 | `origin/1.0.0` 独立于 master；npm `maintenance-1=1.1.2` 已发布且 `latest` 保持 `0.1.59` | 全仓库、`packages/cli`、CI | `20260904-[RELEASE]发布1.1.2维护版本` | 已发布并完成官方源核验 | [`./topics/1.0.0长期维护分支.md`](./topics/1.0.0长期维护分支.md) | 2026-09-04 / `832423f` / `maintenance-1-v1.1.2` |

...
| `RELEASE-LINE-1X` | 1.0.0 长期维护分支 | `origin/1.0.0` 与 CI 已建立并独立于 master；正在发布 npm `maintenance-1`，`latest` 必须保持 `0.1.58` | 全仓库、`packages/cli`、CI | `20260811-[RELEASE]建立1.0.0长期维护分支` | Git/CI 已交付，maintenance-1 发布实施中 | [`./topics/1.0.0长期维护分支.md`](./topics/1.0.0长期维护分支.md) | 2026-08-11 / `4fec572` + 当前工作区 |

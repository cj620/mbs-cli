...
| `UNIFIED-SEMANTIC-DISCOVERY` | 统一语义发现 | 用户只执行自然语言 find；正式 find/describe 经 `/cli/cli-service/cli/api/recall...` 请求，CLI 消费 workflow/api/table 混合候选 | `packages/cli`、`packages/doris`、Skill | `20260812-[BUG]修复语义召回服务路由` | npm maintenance-1 1.0.1 已发布 | [`./topics/统一语义发现.md`](./topics/统一语义发现.md) | 2026-08-12 / `661043b` + 发布后核验 |

...
| `RELEASE-LINE-1X` | 1.0.0 长期维护分支 | 当前功能分支已在本地建立为独立 `1.0.0` 维护线，不与 master 直接合并；V3 本地验证通过，待推送且未发布 npm | 全仓库、`packages/cli`、CI | `20260811-[RELEASE]建立1.0.0长期维护分支` | 本地已验证/待推送/未发布 | [`./topics/1.0.0长期维护分支.md`](./topics/1.0.0长期维护分支.md) | 2026-08-11 / `a8a0bdb` + 当前工作区 |

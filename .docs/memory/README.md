...
| `RELEASE-LINE-1X` | 1.0.0 长期维护分支 | `origin/1.0.0` 已建立并独立于 master；V3 本地验证通过，待远程 CI，npm 未发布 | 全仓库、`packages/cli`、CI | `20260811-[RELEASE]建立1.0.0长期维护分支` | Git 分支已交付/待远程 CI/npm 未发布 | [`./topics/1.0.0长期维护分支.md`](./topics/1.0.0长期维护分支.md) | 2026-08-11 / 初始交付 `0c61a72` + 当前审计更新 |

...
- **当前状态**：普通业务命令及 `find`、`describe`、`serve` 远端路由扩展已随 npm `1.1.4` 发布；业务 500 认证误判修复已随 npm `1.1.5` 发布
- **最后核验时间**：2026-09-08
- **最后核验基线**：`1.0.0@913e6b27b0d63db3aed4c7a09a5e33d4585f53a9` / 306 项测试 + 14 包构建 + 两次 CI/Release/官方包核验
- **权威来源**：[`20260908-[RELEASE]发布1.1.5维护版本`](../../req_doc/20260908-[RELEASE]发布1.1.5维护版本/)

...
- 状态：npm `1.1.0` 已发布 Agent 非交互登录交接与首次登录请求头修复，并完成官方包核验，待真实联调
- 当前来源：`20260904-[RELEASE]发布1.1.0维护版本`、DEC-003、DEC-004、DEC-005、DEC-006
- 最后核验：2026-09-04 / `3295a5e` / npm `1.1.0`
...
Agent 非交互登录交接与首次登录请求头修复已通过完整 V3、维护分支 CI、Release、npm dist-tag 和官方精确版本临时安装/执行核验。Windows 无凭据可见终端冒烟已记录在来源任务中；真实账号、密码和 Token 登录仍未执行。
